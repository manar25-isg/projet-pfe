...
<body id="page-top">
                        ...
                        <li class="nav-item dropdown no-arrow mx-1">
                            ...
                            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="#">
                                    ...
                                    <div>
                                        <div class="small text-gray-500">12 Janvier 2025</div>
                                        <span class="font-weight-bold">Un nouveau compte inscrit</span>
                                    </div>
                                </a>
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <a href="ajouter-service.php" class="btn btn-primary m-2">Nouveau Service </a>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a class="btn btn-danger btn-sm" href="supprimer-service.php?id=<?= $service['id'] ?>"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-x" viewBox="0 0 16 16">
                                                            <path d="M4.646 4.646a.5.5 0 0 1 .708 0L8 7.293l2.646-2.647a.5.5 0 0 1 .708.708L8.707 8l2.647 2.646a.5.5 0 0 1-.708.708L8 8.707l-2.646 2.647a.5.5 0 0 1-.708-.708L7.293 8 4.646 5.354a.5.5 0 0 1 0-.708" />
                                                        </svg></a>
                                                    <a class="btn btn-warning btn-sm" href="modifier-service.php?id=<?= $service['id'] ?>"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil" viewBox="0 0 16 16">
    ...
    $('#dataTable').DataTable({
        language: {
            lengthMenu: "Afficher", // Change "Show" en "Afficher"
            info: "Affichage", // Personnalisation du texte d'info
            search: "Rechercher :", // Personnalisation du champ de recherche
            paginate: {
                first: "Premier",
                last: "Dernier",
                next: "Suivant",
