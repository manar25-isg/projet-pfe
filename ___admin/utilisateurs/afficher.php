...
$utilisateur = mysqli_fetch_assoc(mysqli_query($con, $sql));
?>
<!-- /navbar de site -->
<!-- division de la page -->
<div class="container">
        ...
        <div class="col-8">
            <div class="card">
                <div class="card-header text-center bg-primary text-white"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-people" viewBox="0 0 16 16">
                    ...
                    </svg> Gestion des utilisateurs</div>
                <div class="card-body">
                    <div class="row">
                        <div class="col">
                            <div class="card">
                                <div class="card-header  text-center bg-info text-white">Informations d'utilisateur</div>
                                <div class="card-body">

                                    <div class="row">
                                        <div class="col-md-4 text-center">
                                            <img src="../../assets/images/<?= $utilisateur['avatar'] ?>" alt="" srcset="">
                                        </div>
                                        <div class="col-md-8">
                                            <table class="table table-hover">
                                                <tr>
                                                    <th><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-person" viewBox="0 0 16 16">
                                                ...
                                                <tr>
                                                    <th><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-journal" viewBox="0 0 16 16">
