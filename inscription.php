...
<!-- Header End -->
            <div class="card-body">
              ...
              <form action="" method="POST">
                ...
                <div>
              <button class="btn btn-primary btn-block py-3 px-5" type="submit" name="validate">Valide</button>
              </div>
              <div>
              <button class="btn btn-primary btn-block py-3 px-5" type="submit" name="validate">Annuler</button>
            </div>
            </div>
              </form>
            </div>
